...
def invoke_chain(question, context):
    """
        Invoke the language chain to generate a response based on the given question and context.
        ...
        Returns:
        - str: The response generated by the language chain.
    """
...
if __name__ == "__main__":
    ...
    print(invoke_chain(question, context))
